...
#Include %A_ScriptDir%\assets\layer0\Layer0.ahk
#Include %A_ScriptDir%\assets\layer1\Layer1.ahk
#Include %A_ScriptDir%\assets\layer2\Layer2.ahk
#Include %A_ScriptDir%\assets\layer3\Layer3.ahk
#Include %A_ScriptDir%\assets\layer4\Layer4.ahk
#Include %A_ScriptDir%\assets\layer5\Layer5.ahk
#Include %A_ScriptDir%\assets\layer6\Layer6.ahk

global ApplicationName := "O T A G L E"

global TouchScreenWidth := 600 ; configuration parameter
global TouchScreenHeight := 1024 ; configuration parameter
...
#Include %A_ScriptDir%\assets\Layer0\RunOrActivateWord.ahk
#Include %A_ScriptDir%\assets\Layer0\RunOrActivateKeePass.ahk
#Include %A_ScriptDir%\assets\Layer0\RunOrActivateTotalCommander.ahk
#Include %A_ScriptDir%\assets\Layer1\SetTemplate.ahk
#Include %A_ScriptDir%\assets\Layer1\StrikeThroughText.ahk
#Include %A_ScriptDir%\assets\Layer1\HideSelectedText.ahk
#Include %A_ScriptDir%\assets\Layer2\BB_Insert.ahk
#Include %A_ScriptDir%\assets\Layer3\TemplateStyle.ahk
#Include %A_ScriptDir%\assets\Layer5\Numlock.ahk ; Numpad hostrings
#Include %A_ScriptDir%\assets\Layer6\VBA_RunMacro.ahk
